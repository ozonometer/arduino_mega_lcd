...
#include <Elegoo_GFX/Elegoo_GFX.h>    // Core graphics library
#include <Elegoo_TFTLCD/Elegoo_TFTLCD.h> // Hardware-specific library
...
void setup(void) {
    ...
    tft.setRotation(3); // set to portrait mode
